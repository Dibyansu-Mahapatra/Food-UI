...
class MenuPageBiriyani2ItemWidget extends StatelessWidget {
  MenuPageBiriyani2ItemWidget(this.menuPageBiriyani2ItemModelObj);

  MenuPageBiriyani2ItemModel menuPageBiriyani2ItemModelObj;

  var controller = Get.find<MenuPageBiriyani1Controller>();
