...
class MenuPageBurgerItemWidget extends StatelessWidget {
  MenuPageBurgerItemWidget(this.menuPageBurgerItemModelObj);

  MenuPageBurgerItemModel menuPageBurgerItemModelObj;

  var controller = Get.find<MenuPageBurgerController>();
